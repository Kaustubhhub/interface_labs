...
//     const handleCsvUpload= (event: React.ChangeEvent<HTMLInputElement>, setData: React.Dispatch<React.SetStateAction<any[]>>, setFileName: React.Dispatch<React.SetStateAction<string | null>>) => {

//     }

//     const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>, setData: React.Dispatch<React.SetStateAction<any[]>>, setFileName: React.Dispatch<React.SetStateAction<string | null>>) => {
...
//                 <div className='p-4'>
//                     <label className="block mb-2 text-sm font-medium">Upload payment report</label>
//                     <input
//                         type="file"
//                         accept=".xlsx, .xls"
//                         onChange={(event) => handleFileUpload(event, setPaymentReport, setPaymentReportFileName)}
...
//                     {/* <pre> {JSON.stringify(mtrReport)}</pre> */}
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                ...
                if (result) {
                    ...
                    const csvData = XLSX.utils.sheet_to_json(XLSX.read(text, { type: 'string' }).Sheets["Sheet1"]);
                    setData(csvData);
                    console.log(csvData);
                }
            };
